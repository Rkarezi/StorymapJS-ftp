...
L.Control.Attribution = L.Control.extend({
    options: {
        ...
        prefix: '<a href="http://leafletjs.com" title="A JS library for interactive maps">AlfLeaflet</a>'
    },
    initialize: function(options) {
        L.setOptions(this, options);
        this._attributions = {}
...
VCO.Map.Leaflet = VCO.Map.extend({
    ...
    _createMap: function() {
        ...
        this._map.attributionControl.setPrefix("<a href='' target='_blank' class='vco-knightlab-brand'><span></span></a>");
    ...
    _createTileLayer: function(map_type, options) {
        var _tilelayer = null,
            ...
            _options = {},
            _attribution_knightlab = "<a href='' title='A JS library for interactive maps'></a> | ";
        if (options) {
            _options = options
        }
...
VCO.StoryMap = VCO.Class.extend({
    ...
    _initOptions: function() {
        ...
        if (VCO.Browser.chrome) {
            VCO.Load.css(VCO.Util.urljoin("static", "css/font/font.emoji.css"), function() {
